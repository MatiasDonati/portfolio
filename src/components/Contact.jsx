...
const Contact = () => {
    return (
        <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items p-4'>
            <form method='POST' action="https://getform.io/f/06799291-97c1-4706-8d67-f1722a54d4f5" className='flex flex-col max-w-[600px] w-full pt-16'>
                <div className='pb-8'>
                ...
                <button className='text-white border-2 hover:bg-[#503CD1] hover:border-[#503CD1] px-4 py-3 my-8 mx-auto flex items-center'>Escribime!</button>
